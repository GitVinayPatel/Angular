...
export class RecipeListComponent implements OnInit {
  ...
  recipes: Recipe[] = [
    ...
    new Recipe('Another Test Recipe','This is simply a test','https://get.pxhere.com/photo/dish-meal-food-produce-recipe-fish-breakfast-meat-pork-cuisine-steak-pork-chop-power-dishes-grilling-fried-food-604134.jpg')
];
